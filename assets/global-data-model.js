window.GDM_DATA = {
  ...
  "profiles": {
    ...
    "All fields": [
      ...
      "ingest_pipeline",
      "ingest_run_id",
      "location_ml_suggestion",
      "pii_auto_detected_flag",
      "scraped_html_stored_flag",
      "scraper_source",
      "species_ml_confidence",
      ...
      "collection_method",
      "collection_program",
      "data_source_confidentiality",
      "datahub",
      "date_collected_utc",
      "date_last_updated_utc",
      "legal_sensitivity_flag",
      "monitoring_mode",
      "note",
      "parent_record_id",
      "pii_present_flag",
      ...
      "field_subset_profile",
      "interoperability_profile",
      "schema_version",
      "sharing_license",
      "captive_breeding_claim",
      "cites_taxon_id",
      "col_taxon_id",
      "condition",
      "conservation_notes",
      "gbif_species_key",
      "health_documents_claimed",
      ...
      "seller_phone_hash",
      "similarity_score",
      "capture_browser_user_agent",
      "chain_of_custody_id",
      "evidence_access_control",
      "evidence_storage_system",
      "image_text",
      "integrity_check_date_utc",
      "item_image",
      "media_count",
      "media_exif_datetime",
      "media_exif_gps_lat",
      ...
      "media_types",
      "media_url_list",
      "screen_recording_flag",
      "screenshot_captured_flag",
      "screenshot_file_refs",
      "access_level",
      "ad_language",
      "channel_id",
      "channel_name",
      ...
      "content_translation",
      "content_type",
      "date_observed_first_utc",
      "date_observed_last_utc",
      "date_posted_local",
      ...
      "item_seller_contact",
      "item_seller_name",
      "seller_contact_other",
      "seller_contact_phone",
      "seller_contact_telegram",
      "seller_contact_wechat",
      "seller_contact_whatsapp",
      "seller_display_name",
      "seller_entity_id",
      "seller_entity_resolution_status",
      "seller_external_links",
      "seller_followers_count",
      "seller_following_count",
      "seller_linked_entity_ids",
      "seller_payment_handles",
      "seller_posts_count",
      "seller_profile_image_hash",
      "seller_profile_language",
      "seller_profile_location_text",
      "seller_profile_url",
      "seller_user_id",
      "seller_username",
    ...
    "Automation, scraping, and model-assist fields": [
      "classification_label",
      "content_fingerprint",
      "extraction_confidence",
      "extraction_model_name",
    ...
    "Core record and workflow metadata": [
      "alert_source",
      "analyst_id",
      "analyst_role",
      "collecting_organization",
    ...
    "Geography and geocoding (GADM compatible)": [
      "ad_location",
      "gadm_version",
      "geo_admin0_gadm_id",
      "geo_admin1_gadm_id",
    ...
    "Governance, interoperability, and export controls": [
      "anonymization_level",
      "data_retention_class",
      "export_format",
      "export_request_id",
    ...
    "Item, species, taxonomy, and product fields": [
      "captive_breeding_claim",
      "cites_taxon_id",
      "col_taxon_id",
      "condition",
    ...
    "Legal and enforcement tracking (optional)": [
      "case_id",
      "case_status",
      "court_case_reference",
      "enforcement_outcome",
    ...
    "Linking, dedupe, and network fields": [
      "dedupe_key",
      "duplicate_group_id",
      "duplicate_match_method",
      "duplicate_of_record_id",
    ...
    "Media, evidence, and forensics metadata": [
      "capture_browser_user_agent",
      "chain_of_custody_id",
      "evidence_access_control",
      "evidence_storage_system",
    ...
    "Platform, content, and discovery context": [
      "access_level",
      "ad_language",
      "channel_id",
      "channel_name",
    ...
    "Price, currency, and commercial terms": [
      "availability_status",
      "bulk_terms",
      "discount_details",
      "discount_flag",
    ...
    "Seller and account entity fields": [
      "contact_methods_json",
      "payment_method",
      "seller_account_type",
      "seller_bio_text",
    ...
    "Shipping, routes, and movement indicators": [
      "crossborder_flag",
      "delivery_method",
      "delivery_time_text",
      "destination_country",
    ...
    "Vulnerability and bycatch indicators": [
      "is_bycatch",
      "is_seller_vulnerable_group"
    ]
  },
