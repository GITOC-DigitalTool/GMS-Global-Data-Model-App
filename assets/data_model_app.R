...
data_model_app <- function() {
  ...
  # =============================
  ui <- fluidPage(
    theme = gms_ecosystem_theme(),
    shinyjs::useShinyjs(),
    gms_ecosystem_head(
      "Global Data Model Builder",
      "Build exportable data dictionaries, species prioritisation baskets, and platform prioritisation workbooks within the shared GMS Intel interface.",
      icon = "table-columns"
    ),
    
    tags$head(
      tags$style(HTML("
      .small-help { color: rgba(226,232,240,0.72); font-size: 12px; }
      .summary-box { padding: 14px 16px; background: linear-gradient(180deg, rgba(11,23,40,0.95), rgba(8,18,31,0.95)); border-radius: 16px; margin-bottom: 12px; border:1px solid rgba(0,201,255,0.14); }
      .btn-row { display:flex; gap:8px; }
      .btn-row .btn { flex:1; }
      .pill { display:inline-block; padding:2px 8px; border-radius: 999px; background:rgba(0,201,255,0.10); margin-left:6px; font-size: 12px; color:#dff9ff; border:1px solid rgba(0,201,255,0.16);}
      .rhandsontable, .hot-container { max-width: 100%; overflow-x: auto; }
      /* RSBR table base styling to match dark platform-prioritisation table aesthetic */
      #rsbr_table .rhandsontable .handsontable .htCore td,
      #rsbr_table .handsontable .htCore td,
      #rsbr_table .handsontable td {
        background: #08121f !important;
        color: #e6faff !important;
        border-color: rgba(0, 201, 255, 0.12) !important;
      }
      #rsbr_table .rhandsontable .handsontable .htCore th,
      #rsbr_table .handsontable .htCore th,
      #rsbr_table .handsontable th {
        background: #0b1728 !important;
        color: #e6faff !important;
        border-color: rgba(0, 201, 255, 0.16) !important;
        font-weight: 600;
      }
      #rsbr_table .handsontable .wtHolder,
      #rsbr_table .handsontable .wtHider,
      #rsbr_table .handsontable .wtSpreader,
      #rsbr_table .handsontable .ht_master .wtHolder {
        background: #08121f !important;
      }
      #rsbr_table .handsontable table,
      #rsbr_table .handsontable .htCore {
        background: #08121f !important;
      }
      /* RSBR (rhandsontable) editor inputs: force dark theme so white text remains readable */
      .handsontableInput,
      .handsontableInputHolder textarea,
      .handsontableInputHolder input,
      .handsontable.ht_editor_hidden textarea,
      .handsontable.ht_editor_hidden input {
        background: #08121f !important;
        color: #e6faff !important;
        border: 1px solid rgba(0, 201, 255, 0.24) !important;
      }
      .handsontable .htDropdownMenu,
      .handsontable .htAutocompleteArrow {
        color: #e6faff !important;
      }
      /* Ensure RSBR dropdown editors + menus inherit dark mode */
      #rsbr_table .rhandsontable .handsontable td.htAutocomplete,
      #rsbr_table .rhandsontable .handsontable td.htDropdown,
      #rsbr_table .handsontable td.htAutocomplete,
      #rsbr_table .handsontable td.htDropdown {
        background: #08121f !important;
        color: #e6faff !important;
      }
      .handsontable.listbox,
      .handsontable.htDropdownMenu table.htCore td,
      .handsontable.htDropdownMenu table.htCore th,
      .handsontableEditor,
      .htSelectEditor {
        background: #08121f !important;
        color: #e6faff !important;
        border-color: rgba(0, 201, 255, 0.22) !important;
      }
      .handsontable.listbox table tbody tr td.current,
      .handsontable.listbox table tbody tr td:hover {
        background: rgba(0, 201, 255, 0.18) !important;
        color: #f4feff !important;
      }
      .handsontable .wtBorder {
        border-color: rgba(0, 201, 255, 0.45) !important;
      }
      #rsbr_table .handsontable .currentRow,
      #rsbr_table .handsontable .currentCol,
      #rsbr_table .handsontable .area {
        background: rgba(0, 201, 255, 0.08) !important;
      }
      table.dataTable tbody tr.gms-baseline-row td {
        background: rgba(125, 211, 252, 0.32) !important;
        color: #f8feff !important;
        box-shadow: inset 0 1px 0 rgba(255,255,255,0.04), inset 4px 0 0 rgba(56, 189, 248, 0.95);
      }
      table.dataTable tbody tr.gms-baseline-row:hover td {
        background: rgba(125, 211, 252, 0.42) !important;
      }
      @media (max-width: 767px){ .summary-box { padding: 12px 14px; } }
      "))
    ),
    
    div(class = "gms-app-shell",
            ...
            fluidRow(
              column(
                ...
                div(class = "btn-row",
                    ...
                    actionButton("rsbr_load_example", "Load Example")
                ),
            ...
            fluidRow(
              column(
                ...
                div(
                  ...
                  actionButton("plat_load_example", "Load Example")
                ),
                br(),
                fileInput(
                  "plat_workbook",
  ...
  server <- function(input, output, session) {
    ...
    rsbr_example_data <- function() {
      data.frame(
        Species_common_name = c("African grey parrot","Radiated tortoise","Ploughshare tortoise","Siamese crocodile","Chinese pangolin","Sunda pangolin","Slow loris","Helmeted hornbill","Tiger","Asian elephant","Green iguana","Ball python","Tokay gecko","Blue-and-gold macaw","Sun conure","Koi carp","Seahorses","Arowana (Asian)"),
        Species_scientific_name = c("Psittacus erithacus","Astrochelys radiata","Astrochelys yniphora","Crocodylus siamensis","Manis pentadactyla","Manis javanica","Nycticebus spp.","Rhinoplax vigil","Panthera tigris","Elephas maximus","Iguana iguana","Python regius","Gekko gecko","Ara ararauna","Aratinga solstitialis","Cyprinus rubrofuscus","Hippocampus spp.","Scleropages formosus"),
        IUCN_category = c("EN","CR","CR","CR","CR","CR","EN","CR","EN","EN","LC","LC","LC","LC","EN","NE","DD","EN"),
        CITES_appendix = c("I","I","I","I","I","I","I","I","I","I","II","II","II","II","II","Non-CITES / Not listed","II","I"),
        National_protection = c("Yes","Yes","Yes","Yes","Yes","Yes","Yes","Yes","Yes","Yes","Partial","No","No","No","Partial","No","Partial","Yes"),
        LE_priority = c("Yes","Yes","Yes","Yes","Yes","Yes","Somewhat","Yes","Yes","Yes","No","No","Somewhat","Somewhat","Somewhat","No","Somewhat","Somewhat"),
        Online_presence_score = c(2,2,1,1,2,2,2,1,1,1,1,2,2,1,1,1,1,1),
        stringsAsFactors = FALSE
      )
    }

    plat_example_data <- function() {
      txt <- "Species_common_name\tPlatform_name\tSearch_date\tSearch_time_minutes\tAds_found\tSearch_terms_used\tNotes
Asian elephant\tShopee\t2025-12-16\t30\t3\tpickup; export; captive bred; asian; legal papers\t
African grey parrot\tFacebook Marketplace\t2025-12-11\t60\t13\tafrican; pickup; export; legal papers; parrot\tRepeat seller across groups/channels.
Blue-and-gold macaw\tTokopedia\t2025-12-08\t60\t5\tblue-and-gold macaw; available; captive bred; shipping; wholesale\tClaims captive-bred; no proof in post.
Ball python\tFacebook Marketplace\t2025-12-25\t8\t0\tBall python; shipping; ball; captive bred; wholesale\tMixed language + emojis used.
Chinese pangolin\tTelegram Channel\t2025-11-22\t5\t21\tshipping; chinese pangolin; export; pangolin; legal papers\tClaims captive-bred; no proof in post.
Arowana (Asian)\tOLX\t2025-12-10\t12\t8\tfor sale; delivery; captive bred; price; pickup\tMixed language + emojis used.
Seahorses\tTikTok\t2025-12-14\t30\t3\tcaptive bred; Seahorses; legal papers; seahorses; seahorses\tHigh engagement on comments.
Radiated tortoise\tOLX\t2025-11-26\t40\t3\tDM; captive bred; urgent; radiated tortoise; radiated\tSeller asks to DM for price.
Green iguana\tInstagram\t2025-11-26\t15\t1\tiguana; green; green iguana; delivery; price\tMixed language + emojis used.
African grey parrot\tShopee\t2025-12-01\t12\t13\tavailable; wholesale; urgent; African grey parrot; pickup\tHigh engagement on comments.
Sunda pangolin\tTelegram Group\t2025-12-24\t40\t1\tdelivery; export; price; pickup; wholesale\tHigh engagement on comments.
Helmeted hornbill\tFacebook Marketplace\t2025-12-18\t15\t1\tlegal papers; hornbill; helmeted; price; helmeted hornbill\tMixed language + emojis used.
Chinese pangolin\tTelegram Channel\t2025-12-04\t5\t5\tfor sale; DM; captive bred; wholesale; shipping\tMostly images; minimal text.
Ball python\tCarousell\t2025-12-25\t20\t3\tpickup; urgent; legal papers; shipping; for sale\tSeller asks to DM for price.
Helmeted hornbill\tTelegram Channel\t2026-01-03\t25\t2\tHelmeted hornbill; for sale; urgent; available; DM\tRepeat seller across groups/channels.
Blue-and-gold macaw\tWhatsApp Group\t2025-11-21\t25\t0\tfor sale; blue-and-gold; blue-and-gold macaw; price; legal papers\tSeller asks to DM for price."
      utils::read.delim(text = txt, sep = "\t", stringsAsFactors = FALSE, check.names = FALSE)
    }
    ...
    output$fields_table <- DT::renderDT({
      ...
      dt <- DT::datatable(
        ...
        options    = list(
          ...
          rowCallback    = DT::JS(
            "function(row, data) {",
            "  if (parseInt(data[5], 10) === 1) {",
            "    $(row).addClass('gms-baseline-row');",
            "  } else {",
            "    $(row).removeClass('gms-baseline-row');",
            "  }",
            "}"
          ),
          columnDefs     = list(
    ...
    observeEvent(input$rsbr_load_example, {
      ex <- rsbr_example_data()
      rv_rsbr_raw(ex)
      rv_rsbr$df <- ex
      rsbr_page(1)
      showNotification("Loaded RSBR example data.", type = "message")
    })
    ...
    observeEvent(input$plat_load_example, {
      rv_plat_file(NULL)
      rv_plat_example(plat_example_data())
      showNotification("Loaded Platform Prioritisation example data.", type = "message")
    })
    ...
    output$plat_sheet_select_ui <- renderUI({
      if (!is.null(rv_plat_example())) return(NULL)
      sheets <- plat_sheets()
      req(length(sheets) > 0)
    ...
    plat_results_raw <- reactive({
      if (!is.null(rv_plat_example())) return(rv_plat_example())
      path <- rv_plat_file()
    ...
    plat_scored <- reactive({
      has_example <- !is.null(rv_plat_example())
      has_file <- !is.null(rv_plat_file())
      if (!has_example && !has_file) {
